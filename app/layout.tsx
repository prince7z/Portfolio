...
export const metadata: Metadata = {
  ...
  // Prince-specific keywords (added)
  "Prince Sahu resume",
  "Prince Sahu CV",
  "Prince Sahu contact",
  "Contact Prince Sahu",
  "Hire Prince Sahu",
  "Prince Sahu hire",
  "Prince Sahu services",
  "Prince Sahu consultant",
  "Prince Sahu freelance services",
  "Prince Sahu remote developer",
  "Prince Sahu projects",
  "Prince Sahu portfolio 2026",
  "Prince Sahu code samples",
  "Prince Sahu GitHub",
  "Prince Sahu LinkedIn",
  "Prince Sahu Twitter",
  "Prince Sahu Instagram",
  "princesahu.me",
  "prince7z",
